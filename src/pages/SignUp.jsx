...
const SignUp = () => {
  ...
  return (
    <AuthLayout
      ...
      subheading="Join SayLess in a few seconds."
      footer={
      ...
      asideSubtitle="A modern social space with a dark theme and a clean glass finish."
    >
      <form onSubmit={handleSignUp} className="space-y-4">
        <div>
          <label className="block mb-2 text-sm font-medium text-white/75" htmlFor="signupName">
            Name
          </label>
          <input
            type="text"
        ...
        <div>
          <label className="block mb-2 text-sm font-medium text-white/75" htmlFor="signupEmail">
            Email
          </label>
          <input
        ...
        <div>
          <label className="block mb-2 text-sm font-medium text-white/75" htmlFor="signupPassword">
            Password
          </label>
          <input
